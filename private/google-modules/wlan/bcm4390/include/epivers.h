...
#define EPI_VERSION		(103, 511, 77, 26)

#define EPI_VERSION_NUM		0x671ff4d1u

#define EPI_UNIQUE_NUM		0x671ff4d1au

#define EPI_VERSION_DEV		(103.511.77)

/* Driver Version String, ASCII, 32 chars max */
#if defined(WLTEST)
#define EPI_VERSION_STR		"103.511.77.26 (g642c4f8 WLTEST)"
#elif (defined(BCMDBG_ASSERT) && \
	!defined(BCMDBG_ASSERT_DISABLED) && \
	!defined(ASSERT_FP_DISABLE))
#define EPI_VERSION_STR		"103.511.77.26 (g642c4f8 ASSRT)"
#else
#define EPI_VERSION_STR		"103.511.77.26 (g642c4f8)"
#endif /* BCMINTERNAL */
